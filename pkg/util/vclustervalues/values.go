...
type Values interface {
	Merge(release *v1alpha1.VirtualClusterHelmRelease, logger log.Logger) (string, error)
}
...
func (v *values) Merge(release *v1alpha1.VirtualClusterHelmRelease, logger log.Logger) (string, error) {
