...
func (in *VClusterSpec) DeepCopyInto(out *VClusterSpec) {
	*out = *in
	...
	if in.KubernetesImage != nil {
		in, out := &in.KubernetesImage, &out.KubernetesImage
		*out = new(string)
		**out = **in
	}
	if in.VirtualClusterVersion != nil {
		in, out := &in.VirtualClusterVersion, &out.VirtualClusterVersion
		*out = new(string)
		**out = **in
	}
}
